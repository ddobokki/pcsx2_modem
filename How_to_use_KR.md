...
2. 장치 유형을 **ME56PS2 Modem**으로 설정
3. **Settings** 클릭 후 설정:
   - **Receive Side**: 비활성화 (체크 해제) — 이렇게 하면 Remote Host 입력란이 활성화됨
...
> **참고:** Receive Side가 켜져있는 동안 Remote Host 입력란은 자동으로 회색 처리됩니다 — 발신 측에서만 사용되는 값이기 때문입니다.
